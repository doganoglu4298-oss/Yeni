...
from indicators import get_market_regime, calculate_ema
...
class RegimeBasedBot:
    ...
    # ============================================================
    # 2. TRENDING STRATEJİSİ (Basit EMA Crossover)
    # ============================================================
    def run_trending_strategy(self, df, current_price):
        ...
        logger.info(f"Trend yönü: {direction} | EMA7={ema7:.2f} | EMA25={ema25:.2f}")

        # TODO: Gerçek trend stratejisi emir mantığı buraya gelecek
        if self.config.dry_run:
            logger.info(f"[DRY RUN] {direction} trend emri simüle edildi")
