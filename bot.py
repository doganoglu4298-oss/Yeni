...
# httpx (python-telegram-bot'un altyapısı) INFO seviyesinde her isteğin
# tam URL'sini loglar. Telegram API URL'i bot token'ını içerir
# (https://api.telegram.org/bot<TOKEN>/...), bu yüzden bu logger'ları
# WARNING seviyesine çekip token'ın loglara / Railway ekranına
